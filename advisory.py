...
advice_tool = FunctionTool.from_defaults(provide_advice, name="AdvisoryTool", description="Provide financial advice based on comprehensive financial analysis")
market_analysis_tool = FunctionTool.from_defaults(generate_market_analysis, name="MarketAnalysisTool", description="Generate market analysis")
industry_trends_tool = FunctionTool.from_defaults(generate_industry_trends, name="IndustryTrendsTool", description="Generate industry trends analysis")
financial_ratios_tool = FunctionTool.from_defaults(calculate_financial_ratios, name="FinancialRatiosTool", description="Calculate financial ratios")
portfolio_management_tool = FunctionTool.from_defaults(portfolio_management_advice, name="PortfolioManagementTool", description="Provide portfolio management advice based on risk tolerance")
